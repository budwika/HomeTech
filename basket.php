...
/*$newprodid =$_POST['h_prodid']; //capture the id of selected item
$reququantity =$_POST['p_quantity'];

echo "ID of selected Product:".$newprodid; //Display id of selected product
echo "<br>";
echo "Qty of selected product:".$reququantity; //Display quantity of selected product
*/
