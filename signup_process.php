...
if(empty($fname) or empty($lname) or empty($address) or empty($postcode) or empty($telno) or empty($email) or empty($password1) or empty($password2)){
    ...
    echo "<br><p>All the fields are required.</p> ";
    echo "<br><p>Go back to <a href=signup.php> Sign Up </a></p>";
    echo "<br><br><br>";
}
elseif($password1<>$password2){
    echo "<p><b>Sign Up Failed!</b></p>";
    echo "<br><p>Your passwords are not matching check it carefully.</p> ";
    echo "<br><p>Go back to <a href=signup.php> Sign Up </a></p>";
    echo "<br><br><br>";
}
elseif(!preg_match($reg, $email)){
    echo "<p><b>Sign Up Failed!</b></p>";
    echo "<br><p>Email is not valid.</p> ";
    echo "<br><p>Go back to <a href=signup.php> Sign Up </a></p>";
    echo "<br><br><br>";
}
else{
    ...
    //if sql insertion is successful
    if(mysqli_query($conn, $SQL)){
        echo "<p><b>Sign Up Successfully.</b></p>";
        echo "<p>To proceed please <a href=login.php>login</a></p>";
    }
    //if sql connection is errorness
    else{
